...
<body>
    ...
    <main class="flex column justify-content-center padding-2">
        ...
        <section>
            ...
            <p>Numéro de téléphone : <strong>[Numéro de téléphone]</strong></p>
            <p>Adresse email : <strong>[Adresse email]</strong></p>
            <p>Le directeur de la publication est : <strong>Deschamp Arnaud</strong>.</p>
            <p>Le site est hébergé par : <strong>[Nom de l’hébergeur]</strong>, situé à <strong>[Adresse de l’hébergeur]</strong>, avec le numéro de téléphone <strong>[Numéro de téléphone de l’hébergeur]</strong>.</p>
        </section>
